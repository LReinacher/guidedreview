...
import type { ReviewEvent } from "@guided-review/ui/review/commentTypes";
  ...
  return (
    ...
    >
      ...
      <h2 id={titleId} className="m-0 text-center text-lg font-semibold text-foreground">
        {preview ? "Sample Review Submitted" : "Review Submitted"}
      </h2>
      ...
      >
        {preview
          ? `Preview complete. Nothing was posted to GitHub. Your sample review included ${commentCount} line comment${commentCount === 1 ? "" : "s"}.`
