...
describe("DraftCommentCard", () => {
  it("renders the body in sans text-base and shows Edit / Remove", () => {
    render(<DraftCommentCard comment={draft} onRemove={vi.fn()} onUpdate={vi.fn()} />);
  ...
  it("does not save empty body", () => {
    const onUpdate = vi.fn();
    render(<DraftCommentCard comment={draft} onRemove={vi.fn()} onUpdate={onUpdate} />);
  ...
  it("calls onRemove when Remove is clicked", () => {
    ...
    render(<DraftCommentCard comment={draft} onRemove={onRemove} onUpdate={vi.fn()} />);
